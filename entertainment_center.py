"""Module creates a list of movies and serves it to fresh_tomatoes.open_movies_page()"""
...
PREDESTINATION = media.Movie(
    "Predestination",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMTAzODc3NjU1NzNeQTJeQWpwZ15BbWU4MDk5NTQ4NTMx._V1_SY1000_CR0,0,677,1000_AL_.jpg",
...
GRAN_TORINO = media.Movie(
    "Gran Torino",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMTc5NTk2OTU1Nl5BMl5BanBnXkFtZTcwMDc3NjAwMg@@._V1_.jpg",
    "https://www.youtube.com/watch?v=3WkGaPMInMc"
)

APOCALYPSE_NOW = media.Movie(
    "Apocalypse Now",
    "https://images-na.ssl-images-amazon.com/images/M/MV5BMDg1MDgzMmQtNDhlYS00MzZiLTllZGItNzliZTE1ODBiZDQwXkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_SY1000_CR0,0,658,1000_AL_.jpg",
    "https://www.youtube.com/watch?v=snDR7XsSkB4"
)

movies_list = [PREDESTINATION, WALL_E, INTERSTELLAR, MARTIAN, GRAN_TORINO, APOCALYPSE_NOW]
